...
public interface ActProxyAdministrator extends ActProxyAuthenticated {
	...
	/**
	 * @param txtQestion is a new question
	 * @param txtAnswer is a new answer
	 * @return The success of the method
	...
	/**
	 * A message received from the server side actor saying the options are changed.
	 * 
	 * @return The success of the method
	 * @throws RemoteException
	 */
	public PtBoolean ieOptions() throws RemoteException;
