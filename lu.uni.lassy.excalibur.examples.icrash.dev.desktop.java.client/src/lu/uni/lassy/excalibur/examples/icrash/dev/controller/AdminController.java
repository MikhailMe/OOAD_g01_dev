...
public class AdminController extends AbstractUserController {
	...
	/**
	 * If an administrator is logged in, will change question and answer request to the server. If successful, it will return a PtBoolean of true
	 * @param txtChangeQuestinon is a new question
	 * @param txtChangeAnswer is a new password
	 * @return PtBoolean value of administrator's operation
