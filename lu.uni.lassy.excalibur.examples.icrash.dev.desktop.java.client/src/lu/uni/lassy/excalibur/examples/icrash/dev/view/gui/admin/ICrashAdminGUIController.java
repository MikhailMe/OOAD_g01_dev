...
public class ICrashAdminGUIController extends AbstractAuthGUIController {
	...
	*/
    ...
    @FXML
    private Button bttnBottomAdminCoordinatorOptions;
    ...
    /**
     * The button event that will show options about administrator's authentication 
     *
     * @param event The event type thrown, we do not need this, but it must be specified
     */
    @FXML
    void bttnBottomAdminCoordinatorOptions_OnClick(ActionEvent event){
    	showCoordinatorScreen(TypeOfEdit.Options);
    }
	...
	private void showCoordinatorScreen(TypeOfEdit type){
		...
		case Delete:
			...
			break;
		case Options:
			txtChangeQuestion.setPromptText("New admin secret question");
			txtChangeAnswer.setPromptText("New admin secret answer");
